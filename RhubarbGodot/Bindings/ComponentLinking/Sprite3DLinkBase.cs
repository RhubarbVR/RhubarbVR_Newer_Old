...
namespace RhubarbVR.Bindings.ComponentLinking
{
	...
	public abstract class Sprite3DLinkBase<T, T2> : GeometryInstance3DBase<T, T2> where T : RhuEngine.Components.Sprite3DBase, new() where T2 : Godot.Sprite3D, new()
	{
	...
	public sealed class Sprite3DLink : Sprite3DLinkBase<RhuEngine.Components.Sprite3D, Godot.Sprite3D>
	{
