...
namespace RhubarbVR.Bindings.ComponentLinking
{
	public sealed class LinkedLabel3D : GeometryInstance3DBase<TextLabel3D, Label3D>
	{
		...
		private void TextureFilter_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.TextureFilter = LinkedComp.TextureFilter.Value switch { RElementTextureFilter.Linear => BaseMaterial3D.TextureFilter.Linear, RElementTextureFilter.LinearMipmap => BaseMaterial3D.TextureFilter.LinearWithMipmaps, RElementTextureFilter.NearestMipmap => BaseMaterial3D.TextureFilter.NearestWithMipmaps, RElementTextureFilter.NearestMipmapAnisotropic => BaseMaterial3D.TextureFilter.NearestWithMipmapsAnisotropic, RElementTextureFilter.LinearMipmapAnisotropic => BaseMaterial3D.TextureFilter.LinearWithMipmapsAnisotropic, _ => BaseMaterial3D.TextureFilter.Nearest, });
		}
