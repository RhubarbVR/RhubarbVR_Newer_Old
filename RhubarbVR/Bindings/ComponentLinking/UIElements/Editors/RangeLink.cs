...
{
	public abstract class RangeBase<T, T2> : UIElementLinkBase<T, T2> where T : RhuEngine.Components.Range, new() where T2 : GDExtension.Range, new()
	{
	...
	public sealed class RangeLink : RangeBase<RhuEngine.Components.Range, GDExtension.Range>
	{
