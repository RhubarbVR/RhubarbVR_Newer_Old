...
{
	public sealed class ScrollContainerLink : ContainerBase<RhuEngine.Components.ScrollContainer, GDExtension.ScrollContainer>
	{
		...
		private void VerticalScrollBar_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.VerticalScrollMode = LinkedComp.VerticalScrollBar.Value switch { RScrollBarVisibility.Auto => GDExtension.ScrollContainer.ScrollMode.Auto, RScrollBarVisibility.AlwaysShow => GDExtension.ScrollContainer.ScrollMode.ShowAlways, RScrollBarVisibility.NeverShow => GDExtension.ScrollContainer.ScrollMode.ShowNever, _ => GDExtension.ScrollContainer.ScrollMode.Disabled, });
		}

		private void HorizontalScrollBar_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.HorizontalScrollMode = LinkedComp.HorizontalScrollBar.Value switch { RScrollBarVisibility.Auto => GDExtension.ScrollContainer.ScrollMode.Auto, RScrollBarVisibility.AlwaysShow => GDExtension.ScrollContainer.ScrollMode.ShowAlways, RScrollBarVisibility.NeverShow => GDExtension.ScrollContainer.ScrollMode.ShowNever, _ => GDExtension.ScrollContainer.ScrollMode.Disabled, });
		}
