...
{
	public sealed class NinePatchRectLink : UIElementLinkBase<RhuEngine.Components.NinePatchRect, GDExtension.NinePatchRect>
	{
		...
		private void Vertical_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.AxisStretchVertical = LinkedComp.Vertical.Value switch { RNinePatchRectStretch.Tile => GDExtension.NinePatchRect.AxisStretchMode.Tile, RNinePatchRectStretch.TileFit => GDExtension.NinePatchRect.AxisStretchMode.TileFit, _ => GDExtension.NinePatchRect.AxisStretchMode.Stretch, });
		}

		private void Horizontal_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.AxisStretchHorizontal = LinkedComp.Horizontal.Value switch { RNinePatchRectStretch.Tile => GDExtension.NinePatchRect.AxisStretchMode.Tile, RNinePatchRectStretch.TileFit => GDExtension.NinePatchRect.AxisStretchMode.TileFit, _ => GDExtension.NinePatchRect.AxisStretchMode.Stretch, });
		}
