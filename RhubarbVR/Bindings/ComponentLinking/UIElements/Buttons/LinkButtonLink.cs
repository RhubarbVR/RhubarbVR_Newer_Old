...
{
	public sealed class LinkButtonLink : ButtonBase<RhuEngine.Components.LinkButton, GDExtension.LinkButton>
	{
		...
		private void UnderLine_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.Underline = LinkedComp.UnderLine.Value switch { RUnderLine.OnHover => GDExtension.LinkButton.UnderlineMode.OnHover, RUnderLine.Never => GDExtension.LinkButton.UnderlineMode.Never, _ => GDExtension.LinkButton.UnderlineMode.Always, });
		}
