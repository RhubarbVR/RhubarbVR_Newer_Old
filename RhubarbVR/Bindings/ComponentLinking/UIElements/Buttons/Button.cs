...
{
	public abstract class Button<T, T2> : ButtonBase<T, T2> where T : RhuEngine.Components.Button, new() where T2 : GDExtension.Button, new()
	{
	...
	public sealed class ButtonLink : Button<RhuEngine.Components.Button, GDExtension.Button>
	{
