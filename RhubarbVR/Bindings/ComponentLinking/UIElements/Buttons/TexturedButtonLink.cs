...
{
	public sealed class TexturedButtonLink : ButtonBase<RhuEngine.Components.TexturedButton, GDExtension.TextureButton>
	{
		...
		private void StretchMode_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.StretchModeValue = LinkedComp.StretchMode.Value switch { RTexturedButtonStretchMode.Tile => TextureButton.StretchMode.Tile, RTexturedButtonStretchMode.Keep => TextureButton.StretchMode.Keep, RTexturedButtonStretchMode.KeepCenter => TextureButton.StretchMode.KeepCentered, RTexturedButtonStretchMode.KeepAsspect => TextureButton.StretchMode.KeepAspect, RTexturedButtonStretchMode.KeepAsspectCenter => TextureButton.StretchMode.KeepAspectCentered, RTexturedButtonStretchMode.KeepAsspectCovered => TextureButton.StretchMode.KeepAspectCovered, _ => TextureButton.StretchMode.Scale, });
		}
