...
{
	public sealed class OptionsButtonLink : Button<RhuEngine.Components.OptionButton, GDExtension.OptionButton>
	{
		...
		private void Selected_Changed(IChangeable obj) {
			RenderThread.ExecuteOnEndOfFrame(() => node.Select(LinkedComp.Selected.Value));
		}
	}
}
