...
namespace RNumerics
{
	...
	public struct Triangle3d
	{
		...
		public static implicit operator Triangle3d(Triangle3f v) => new(v.V0, v.V1, v.V2);
		public static explicit operator Triangle3f(Triangle3d v) => new((Vector3f)v.V0, (Vector3f)v.V1, (Vector3f)v.V2);
	}
