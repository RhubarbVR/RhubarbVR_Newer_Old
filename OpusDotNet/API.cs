...
namespace OpusDotNet
{
	...
	internal static class API
	{
		...
		[DllImport("opus", CallingConvention = CallingConvention.Cdecl)]
		public static extern int opus_encode_float(SafeEncoderHandle st, byte[] pcm, int frame_size, byte[] data, int max_data_bytes);
		// Decoder
		...
		[DllImport("opus", CallingConvention = CallingConvention.Cdecl)]
		public static extern int opus_decode_float(SafeDecoderHandle st, byte[] data, int len, byte[] pcm, int frame_size, int decode_fec);
		// Helper Methods
