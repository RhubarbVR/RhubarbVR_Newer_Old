...
namespace RhuEngine.Components
{
	...
	public sealed class Window : Component
	{
		...
		public readonly SyncRef<UI3DCanvas> Canvas;
		...
		protected override void OnAttach() {
			...
			(Entity, UI3DSprite) AddButton(Entity were, float PADDING, Vector2i iconindex, Action<ButtonEvent> action) {
			...
			Canvas.Target = Entity.AttachComponent<UI3DCanvas>();
			Canvas.Target.scale.Value = new Vector3f(10, 8, 1.5f);
			var rect = Entity.AttachComponent<UI3DRect>();
			var grabber = Entity.AttachComponent<UI3DGrabInteraction>();
			...
			var windowRootrect = windowRoot.AttachComponent<UI3DRect>();
			...
			var headerrect = header.AttachComponent<UI3DRect>();
			...
			var headerTextSiderect = headerTextSide.AttachComponent<UI3DRect>();
			...
			var rectoffset = headerTextSide.AttachComponent<UI3DRect>();
			...
			var headerButtonSiderect = headerButtonSide.AttachComponent<UI3DRect>();
			...
			var headerButtonSiderecth = headerButtonSideh.AttachComponent<UI3DHorizontalList>();
			...
			var img = Entity.AttachComponent<UI3DRectangle>();
			colorassign = Entity.AttachComponent<ColorAssign>();
