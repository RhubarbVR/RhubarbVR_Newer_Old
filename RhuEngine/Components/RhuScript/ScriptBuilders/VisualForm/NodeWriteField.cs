...
//			Value.Target = LoadNodeButton(entity, typeof(World), -0.001f, "Value");
//			Input.Target.RenderLabel.Value = true;
//			Value.Target.RenderLabel.Value = true;
//			UI.Target = entity;
...
//			var scriptNodeMethod = (ScriptNodeWriteField)node;
//			Same(Builder);
