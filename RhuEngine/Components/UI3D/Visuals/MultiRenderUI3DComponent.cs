...
{
	public abstract class MultiRenderUI3DComponent : BaseRenderUI3DComponent
	{
		...
		public override void ProcessMeshUpdate() {
			...
			switch (UIRect.RenderMeshUpdate) {
				case UI3DRect.RenderMeshUpdateType.FullResized:
					UpdateMesh();
					MovedMeshUpdate();
					FinalMeshUpdate();
					UpdateRMeshForRender();
					break;
				case UI3DRect.RenderMeshUpdateType.Movment:
					MovedMeshUpdate();
					FinalMeshUpdate();
					UpdateRMeshForRender();
					break;
				case UI3DRect.RenderMeshUpdateType.CutMesh:
					MovedMeshUpdate();
					FinalMeshUpdate();
					UpdateRMeshForRender();
					break;
				case UI3DRect.RenderMeshUpdateType.BindAndCanvasScale:
					FinalMeshUpdate();
					UpdateRMeshForRender();
					break;
				default:
