...
namespace RhuEngine.Components
{
	...
	public class LineEdit : UIElement
	{
		...
		[Default("•")]public readonly Sync<string> SecretCharacter;
		public readonly Sync<bool> ExpandToTextLength;
		[Default(true)]public readonly Sync<bool> ContextMenuEnabled;
		...
		[Default(true)]public readonly Sync<bool> CaretMidGrapheme;
