...
namespace RhuEngine.Components
{
	...
	public class TextEdit : UIElement
	{
		...
		[Default(true)]public readonly Sync<bool> ContectMenuEnabled;
		[Default(true)]public readonly Sync<bool> ShortcutKeysEnabled;
		[Default(true)]public readonly Sync<bool> SelectingEnabled;
		[Default(true)]public readonly Sync<bool> DeselectingOnFocusLossEnabled;
		[Default(true)]public readonly Sync<bool> DragAndDropSelectionEnabled;
		[Default(true)]public readonly Sync<bool> VirtualKeyboardEnabled;
		[Default(true)]public readonly Sync<bool> MiddleMousePasteEnabled;
		...
		[Default(80)]public readonly Sync<int> MiniMapWidth;
		public readonly Sync<bool> LineCaret;
		public readonly Sync<bool> CaretBlink;
		[Default(0.65f)]public readonly Sync<float> BlinkInterval;
		[Default(true)]public readonly Sync<bool> MoveOnRightClick;
		[Default(true)]public readonly Sync<bool> MidGrapheme;
